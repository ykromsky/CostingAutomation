...
namespace StandardVesselEstimator
{
    class MVI : Package
    {
        ...
        public MVI(ProductInfo info) : base(info) { }
        ...
        public void VI_list()
        {
            Add_block_title("VI VESSEL");

            vi = new VI(productInfo);
        ...
        public void Level_column_list()
        {
            ...
            if (productInfo.PackageSize == "MVI-144") {
