...
namespace StandardVesselEstimator
{
    class VSD : Vessel
    {
        public VSD(ProductInfo info) : base(info) { }

        public List<ListItem> VSD_12_48()
        {
            ...
            Add_angle_clip_item(2, "SA36", 3, 0.25, 7);
            ...
            Add_nozzle_item(1, "PIPE", "RELIEF", "SA106B", 1.5, "S/80", 10.5);
            Add_nozzle_item(1, "PIPE", "LIQUID FEED", "SA106B", 0.75, "S/80", 10.5);
        ...
        public List<ListItem> VSD_16_54()
        {
            Add_nameplate_item("SA36", 6);
            Add_backer_item(2, 16);
            Add_pipe_shell_item(1, "SA53B-ERW", 16, "STD", 41);
            ...
            Add_nozzle_item(2, "PIPE", "COLUMN CONN", "SA106B", 1.5, "S/80", 9);
            Add_nozzle_item(1, "PIPE", "RELIEF", "SA106B", 1.5, "S/80", 11);
        ...
        public List<ListItem> VSD_24_60()
        {
            Add_nameplate_item("SA36", 6);
            Add_backer_item(2, 24);
            Add_pipe_shell_item(1, "SA53B-ERW", 24, "STD", 43.5);
        ...
        public List<ListItem> VSD_30_72()
        {
            Add_nameplate_item("SA36", 6);
            Add_backer_item(2, 30);
            Add_od_rolled_shell_item(1, "SA516-70", 30, 0.375, 53);
        ...
        public List<ListItem> VSD_36_78()
        {
            Add_nameplate_item("SA36", 6);
            Add_backer_item(2, 36);
            Add_od_rolled_shell_item(1, "SA516-70", 36, 0.375, 56);
            Add_head_items(2, "OD ELLIP HEAD", "SA516-70", 36, 0.375);
            Add_angle_clip_item(2, "SA36", 6, 0.375, 7);
            ...
            Add_nozzle_item(1, "PIPE", "LIQUID FEED", "SA106B", 2, "S/80", 10.5);
            Add_nozzle_item(1, "PIPE", "RELIEF", "SA106B", 1.5, "S/80", 10.5);
            Add_nozzle_item(2, "PIPE", "COLUMN CONN", "SA106B", 1.5, "S/80", 9);
        ...
        public List<ListItem> VSD_42_84()
        {
            Add_nameplate_item("SA36", 6);
            Add_backer_item(2, 42);
            Add_od_rolled_shell_item(1, "SA516-70", 42, 0.375, 59);
